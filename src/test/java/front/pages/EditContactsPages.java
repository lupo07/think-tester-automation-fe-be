...
public class EditContactsPages {
	WebDriver driver;
	...
	public EditContactsPages(WebDriver driver) {
		this.driver = driver;
	...
	public void verifyAddContactsPage(String product) {
		spv.verifyPageHeader(editContactsHeader, product, ConstantsFront.EXPLICIT_WAIT_ADD_CONTACTS_PAGE);
	}
